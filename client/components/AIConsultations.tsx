        ...
        {consultationTypes.map((consultation) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                consultation.available && setSelectedConsultation(consultation)
              }
            >
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="border-2 border-white text-white px-6 py-3 rounded-xl font-semibold hover:bg-white hover:text-blue-600 transition-colors flex items-center gap-2">
